...
export class Fish {
  constructor() {
    ...
    let fishRotation = [Math.PI * -0.5, Math.PI * 0.1, Math.PI * 1.0];
    let fishPosition = [-40, 70, 0];
    let fishScale = [8, 8, 8];
    ...
    mtlLoader.load(
      "/assets/models/fish/fish5/13009_Coral_Beauty_Angelfish_v1_l3.mtl",
      mtlParseResult => {
        ...
        objLoader.load(
          "/assets/models/fish/fish5/13009_Coral_Beauty_Angelfish_v1_l3.obj",
          root => {
            root.rotation.set(
              fishRotation[0],
              fishRotation[1],
