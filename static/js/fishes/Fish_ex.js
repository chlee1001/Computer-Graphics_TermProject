...
import * as Helper from "/assets/helpers.js";
...
export class Fish {
  ...
  update() {
    ...
    let targetX = Helper.normalize(mousePos.x, -1, 1, this.minX, this.maxX);
    let targetY = Helper.normalize(mousePos.y, -1, 1, this.minY, this.maxY);
    ...
    this.mesh.rotation.z = (targetY - this.mesh.position.y) * 0.005;
